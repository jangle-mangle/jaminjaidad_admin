                    ...
                    <div class="single-right-content">
                        <div class="navbar-right-flex top-fless">
                            <div class="af-log">
                                ...
                                <div class="af-two">
                                <div class="af-nam">
                                    <h2 class="btn btn-default kab-ba">{{auth()->user()->name}}</h2>
                                </div>
                            ...
                            <div class="navbar-right-btn btn-wrapper">
                                <a href="javascript:void(0)" class="login-press cmn-btn btn-bg-1 radius-10" type="button" data-bs-toggle="modal" > Log Out </a>
                            </div>
