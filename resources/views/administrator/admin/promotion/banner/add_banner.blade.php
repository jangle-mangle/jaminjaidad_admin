...
<div class="col-md-12">
    ...
    <input type="file" id="banner_image" class="form-control mb-2" name="banner_image"/>
    
    <label class="form-label" for="text"><b>Banner Position</b></label>
    <input type="text" id="position" class="form-control mb-2" name="position" placeholder="Enter Price"/>
   ...
   <label class="form-label" for="text"><b>Banner Location</b></label>
                        ...
                        <div class="col-12 pt-1 pb-1 shadow">
                          <div id="map-search-box" style="flex:4;">
                            <input type="search" id="address_search" class="form-control" placeholder="Search your location here...*" required />
                          ...
                          <div class="mt-1 row">
                            ...
                            <input type="hidden" id="loc_latitude" name="loc_latitude"  required/>
                            <input type="hidden" id="loc_longitude" name="loc_longitude" required/>
                            <input type="hidden" id="loc_address" name="loc_address"  required/>
                          </div>
                        </div>
                        </div>
                        </div>
...
$.ajax({
	type: "post",
	data: formData,
    url: "{{route('admin.add_banner_detail')}}",
	cache:false,
	contentType: false,
	processData: false,
