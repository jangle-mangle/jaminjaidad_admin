...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="{{asset('images/logo/hometoexam.png')}}">
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;1,400;1,500;1,600" rel="stylesheet">

  {{-- Include core + vendor Styles --}}
  @include('administrator.panels.styles')
...
data-menu="vertical-menu-modern" data-col="{{ $configData['showMenu'] === true ? '2-columns' : '1-column' }}" data-layout="{{ ($configData['theme'] === 'light') ? '' : $configData['layoutTheme'] }}" style="{{ $configData['bodyStyle'] }}" data-framework="laravel" data-asset-path="{{ asset('/')}}">
  ...
  @include('administrator.panels.sidebar')
  @endif

  {{-- Include Navbar --}}
  @include('administrator.panels.navbar')
  ...
  <div class="app-content content {{ $configData['pageClass'] }}">
    ...
    <div class="content-wrapper {{ $configData['layoutWidth'] === 'boxed' ? 'container-xxl p-0' : '' }}">
      ...
      @include('administrator.panels.breadcrumb')
      @endif
  ...
  {{-- include footer --}}
  @include('administrator.panels.footer')

  {{-- include default scripts --}}
  @include('administrator.panels.scripts')
