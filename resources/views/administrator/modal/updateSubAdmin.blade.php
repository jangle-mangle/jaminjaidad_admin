  ...
  <div class="modal-dialog modal-dialog-top modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary ml-1 update-vendor-btn">
...
$(document).on('click', '.vendor-edit-btn', function() {
...
$(document).on('click', '.update-vendor-btn', function() {
    ...
    $.ajax({
        ...
        success: function(result) {
            $('.update-vendor-btn').html('Update').attr('disabled', false);
